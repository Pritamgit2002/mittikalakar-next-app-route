...
const About = () => {
  return (
    <div>
      ...
      <div className="">
        <Fade left>
          <div className="rounded-lg md:flex font-semibold items-center justify-center gap-4  h-[460px]">
            <div className="  h-80 w-96 m-10 rounded-3xl my-8 flex justify-center items-center flex-col hover:shadow-2xl hover:shadow-[#C1DCDC]">
              <div className="bg-[#C1DCDC] rounded-full border-2 border-blue-500">
            ...
            <div className="  h-80 w-96 m-10 rounded-3xl my-8 flex justify-center items-center flex-col hover:shadow-xl hover:shadow-[#C1DCDC]">
